...
mod tests {
    ...
    #[test]
    fn test_customer_updated_event_handler_handle_message() -> anyhow::Result<()> {
        let mut mock_listener = MockCustomerMessageListener::new();
        ...
        let handler = CustomerUpdatedEventHandler::new(Arc::new(mock_listener));
        handler.handle_message(&avro_payload)?;
    ...
    #[test]
    fn test_customer_updated_event_handler_handle_message_with_invalid_id() -> anyhow::Result<()> {
        let mut mock_listener = MockCustomerMessageListener::new();
